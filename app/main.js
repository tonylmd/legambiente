...
var _lutIconSpecs = {
    normal: new IconSpecs(28, 45, 3, 8),
    medium: new IconSpecs(32, 52, 3, 8),
    large: new IconSpecs(32, 52, 3, 11)
}
...
var ICON_ALL_SUFFIX = ".png";
var ICON_MTYPE1_PREFIX = "resources/MIcons/MType1/";
var ICON_MTYPE2_PREFIX = "resources/MIcons/MType2/";
var ICON_MTYPE3_PREFIX = "resources/MIcons/MType3/";
var ICON_MTYPE4_PREFIX = "resources/MIcons/MType4/";
var ICON_MTYPE5_PREFIX = "resources/MIcons/MType5/";
var ICON_MTYPE6_PREFIX = "resources/MIcons/MType6/";
var ICON_MTYPE7_PREFIX = "resources/MIcons/MType7/";
...
function init() {
    ...
    var mapDeferred = esri.arcgis.utils.createMap(_configOptions.webmap_overview, "mapOV", {
        ...
        var states = new esri.layers.FeatureLayer(statesUrl, {id: "states"});
        mapDeferred.addLayer(states);
        ...
        labels.addFeatureLayer(states, statesLabelRenderer, "test");
        // add the label layer to the map
        mapDeferred.addLayer(labels);
       */ 
...
function transfer() {
    ...
    if (_selected.attributes.FLICKR_URL !== undefined && _selected.attributes.FLICKR_URL != null && _selected.attributes.FLICKR_URL != "") {
        ...
        popup_html_model += "<param name=\"flashvars\" value=\"offsite=true&lang=it-it&page_show_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2Fshow&page_show_back_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2F&set_id=" + _selected.attributes.FLICKR_URL + "&jump_to=\" />";
        ...
        popup_html_model += "<embed type=\"application/x-shockwave-flash\" src=\"http://www.flickr.com/apps/slideshow/show.swf?v=140556\" allowfullscreen=\"true\" flashvars=\"offsite=true&lang=it-it&page_show_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2Fshow&page_show_back_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2F&set_id=" + _selected.attributes.FLICKR_URL + "&jump_to=\" width=\"640\" height=\"480\" /></object>";
        ...
        if (_selected.attributes.THUMB_URL !== undefined && _selected.attributes.THUMB_URL != null && _selected.attributes.THUMB_URL != "" && _selected.attributes.IMAGE_URL !== undefined && _selected.attributes.IMAGE_URL != null && _selected.attributes.IMAGE_URL != "") {
        	...
        	window_html_model += "<div class=\"mediaSection\"> <div class=\"gallery\"> <div class=\"frame image\" dojoattachpoint=\"_mediaFrame\" style=\"-webkit-user-select: none;\"> <a target=\"_blank\" href=\"" + "resources/images/logo_big.png" + "\"> <img class=\"esriPopupMediaImage\" src=\"" + "resources/images/logo_big.png" + "\" style=\"margin-top: 8px;\"></a> </div> </div> </div>";
        }
    }
    if (_selected.attributes.TAG !== undefined && _selected.attributes.TAG != null && _selected.attributes.TAG != "")
        popup_html_model += "<div class=\"single-row\"> <b>Tipo Evento:&nbsp;</b><br /> " + _selected.attributes.TAG + "</div><br />";
    if (_selected.attributes.NAME !== undefined && _selected.attributes.NAME != null && _selected.attributes.NAME != "")
        popup_html_model += "<div class=\"single-row\"> <b>Città:&nbsp;</b><br /> " + _selected.attributes.NAME + "</div><br />";
    if (_selected.attributes.DATE !== undefined && _selected.attributes.DATE != null && _selected.attributes.DATE != "")
        popup_html_model += "<div class=\"single-row\"> <b>Date:&nbsp;</b><br /> " + _selected.attributes.DATE + "</div><br />";
    ...
    if (_selected.attributes.ALLEGATO1 !== undefined && _selected.attributes.ALLEGATO1 != null && _selected.attributes.ALLEGATO1 != "")
        popup_html_model += "<div class=\"single-row\"> <b>Allegato 1:&nbsp;</b><a target=\"_blank\" class=\"scarica-documento\" href=\"" + _selected.attributes.ALLEGATO1 + "\">Allegato 1</a> </div><br />";
    if (_selected.attributes.ALLEGATO2 !== undefined && _selected.attributes.ALLEGATO2 != null && _selected.attributes.ALLEGATO2 != "")
        popup_html_model += "<div class=\"single-row\"> <b>Allegato 2:&nbsp;</b><a target=\"_blank\" class=\"scarica-documento\" href=\"" + _selected.attributes.ALLEGATO2 + "\">Allegato 2</a> </div><br />";
    if (_selected.attributes.ALLEGATO3 !== undefined && _selected.attributes.ALLEGATO3 != null && _selected.attributes.ALLEGATO3 != "")
        popup_html_model += "<div class=\"single-row\"> <b>Allegato 3:&nbsp;</b><a target=\"_blank\" class=\"scarica-documento\" href=\"" + _selected.attributes.ALLEGATO3 + "\">Allegato 3</a> </div><br />";
    if (_selected.attributes.ALLEGATO4 !== undefined && _selected.attributes.ALLEGATO4 != null && _selected.attributes.ALLEGATO4 != "")
        popup_html_model += "<div class=\"single-row\"> <b>Allegato 4:&nbsp;</b><a target=\"_blank\" class=\"scarica-documento\" href=\"" + _selected.attributes.ALLEGATO4 + "\">Allegato 4</a> </div><br />";
    ...
    if (_selected.attributes.ANAGRAFICA !== undefined && _selected.attributes.ANAGRAFICA != null && _selected.attributes.ANAGRAFICA != "") {
        ...
        window_html_model += "<div class=\"single-row\"> " + _selected.attributes.TAG+", "+ _selected.attributes.NAME+", "+ _selected.attributes.DATE + "</div><br />";

    window_html_model += "<div class=\"break\"></div></div>";
    if (_selected.attributes.FLICKR_URL !== undefined && _selected.attributes.FLICKR_URL != null && _selected.attributes.FLICKR_URL != "") {
        window_html_model += "<object width=\"420\" height=\"320\">";
        window_html_model += "<param name=\"flashvars\" value=\"offsite=true&lang=it-it&page_show_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2Fshow&page_show_back_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2F&set_id=" + _selected.attributes.FLICKR_URL + "&jump_to=\" />";
        ...
        window_html_model += "<embed type=\"application/x-shockwave-flash\" src=\"http://www.flickr.com/apps/slideshow/show.swf?v=140556\" allowfullscreen=\"true\" flashvars=\"offsite=true&lang=it-it&page_show_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2Fshow&page_show_back_url=photos%2F125087957@N05%2Fsets%2F" + _selected.attributes.FLICKR_URL + "%2F&set_id=" + _selected.attributes.FLICKR_URL + "&jump_to=\" width=\"420\" height=\"320\" /></object>";
    }
    else {
        if (_selected.attributes.THUMB_URL !== undefined && _selected.attributes.THUMB_URL != null && _selected.attributes.THUMB_URL != "" && _selected.attributes.IMAGE_URL !== undefined && _selected.attributes.IMAGE_URL != null && _selected.attributes.IMAGE_URL != "") {
            window_html_model += "<div class=\"mediaSection\"> <div class=\"gallery\"> <div class=\"frame image\" dojoattachpoint=\"_mediaFrame\" style=\"-webkit-user-select: none;\"> <a target=\"_blank\" href=\"" + _selected.attributes.IMAGE_URL + "\"> <img class=\"esriPopupMediaImage\" src=\"" + _selected.attributes.THUMB_URL + "\" style=\"margin-top: 8px;\"></a> </div> </div> </div>";
...
function loadList() {
    ...
    $.each(_locations, function (index, value) {
        switch (value.attributes.TAG) {
            case "Allagamenti da piogge intense":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE1_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            case "Danni al patrimonio archeologico da piogge intense":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE2_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            case "Danni alle infrastrutture da piogge intense":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE3_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            case "Danni da trombe d'aria":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE4_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            case "Esondazioni fluviali":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE5_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            case "Frane da piogge intense":
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE6_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
            default:
                value.setSymbol(new esri.symbol.PictureMarkerSymbol(
			ICON_MTYPE7_PREFIX + value.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX,
			spec.getWidth(),
			spec.getHeight()).setOffset(spec.getOffsetX(), spec.getOffsetY()));
                break;
        }
...
function preSelection() {
    ...
    if (_selected) {
        ...
        var url = ICON_MTYPE7_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
        switch (_selected.attributes.TAG) {
            case "Allagamenti da piogge intense":
                var url = ICON_MTYPE1_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
            case "Danni al patrimonio archeologico da piogge intense":
                var url = ICON_MTYPE2_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
            case "Danni alle infrastrutture da piogge intense":
                var url = ICON_MTYPE3_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
        	case "Danni da trombe d'aria":
                var url = ICON_MTYPE4_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
            case "Esondazioni fluviali":
                var url = ICON_MTYPE5_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
            case "Frane da piogge intense":
                var url = ICON_MTYPE6_PREFIX + _selected.attributes.getValueCI(_configOptions.fieldName_Rank) + ICON_ALL_SUFFIX;
                break;
        }
...
function addPhotos(data, key) {
    ...
    var template = new esri.dijit.PopupTemplate({
        title: "{title}",
        description: "<p><a href=\"http://www.flickr.com/people/125087957@N05/\">{ownername}<\/a> ha aggiunto questa foto:<\/p> <p><a href=\"http://www.flickr.com/photos/125087957@N05/{id}/\" title=\"{title}\"><img src=\"{url_s}\" width=\"{width_s}\" height=\"{height_s}\" alt=\"{title}\" /><\/a><\/p>"
    });
